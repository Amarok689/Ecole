...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data_call', models.DateField(verbose_name='Date')),
                ('Reasson', models.CharField(blank=True, default='', help_text='Why the student is missing?', max_length=255, verbose_name='Reasson')),
